Feature: Navigate through reddit
  ...
  @sub
  Scenario Outline: Navigate to subreddit
  ...
  @home
  Scenario Outline: Clicking on the header image on the banner sends you to the home page
    Given I have the following <subreddit> subreddit
    When I click on <subreddit> subreddit
    Then I navigate to <subreddit> subreddit
  ...
  @tab
  Scenario Outline: Clicking on the tabs in the tab menu sends me to the respective tab page
    Given I have the following <subreddit> subreddit
    When I click on <subreddit> subreddit
    Then I navigate to <subreddit> subreddit
